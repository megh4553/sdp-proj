...
const Header = () => {
    ...
    return (
        <Navbar collapseOnSelect expand="lg" fixed="top">
            <LinkContainer to="/">
                <Navbar.Brand href="/"><h5 className="nav-header">AgriTech</h5></Navbar.Brand>
            </LinkContainer>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="mr-auto ">
                    ...
                    <LinkContainer to="/consumer">
                        <Nav.Link className="nav-cal">PRODUCT</Nav.Link>
                    </LinkContainer>
                    <LinkContainer to="login?redirect=supplier">
                        <Nav.Link className="nav-cal">ADD PRODUCT</Nav.Link>
                    </LinkContainer>
