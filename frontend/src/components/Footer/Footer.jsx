                ...
                <MDBContainer className="mt-5 mb-4 text-center text-md-left">
                    <MDBRow className="mt-3">
                        ...
                        <MDBCol md="2" lg="2" xl="2" className="mb-4 dark-grey-text">
                            ...
                            <p><Link to="/consumer" className="dark-grey-text">Product </Link></p>
                            <p><Link to="/supplier" className="dark-grey-text">Add Product</Link></p>
                        ...
                        <MDBCol md="3" lg="3" xl="4" className="mb-4 dark-grey-text">
                            ...
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px" }} />
                            <p><i className="fa fa-home mr-3" /> Gujarat, India</p>
                            <p><i className="fa fa-envelope mr-3" /> info@example.com</p>
                            <p><i className="fa fa-phone mr-3" /> + 01 6351170115</p>
                            <p><i className="fa fa-print mr-3" /> + 01 9265804678</p>
                        </MDBCol>
