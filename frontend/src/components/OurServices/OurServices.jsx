    ...
    return (
        <Container className="main" fluid>
            ...
            <p className="description">
                Our website provides a platform to buy and sell for the agriculture activities like farming, harvesting and preserve your goods by
                ferililzers and make farmers life little easy is out ultimate moto.
                </p>
